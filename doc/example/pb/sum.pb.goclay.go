...
func (d *SummatorDesc) SwaggerDef(options ...swagger.Option) (result []byte) {
	if len(options) > 0 {
		...
		if err = swagger.UnmarshalJSON(_swaggerDef_doc_example_pb_sum_proto); err != nil {
		...
		result = _swaggerDef_doc_example_pb_sum_proto
	}
	return result
}
...
var _swaggerDef_doc_example_pb_sum_proto = []byte(`{
  "swagger": "2.0",
  "info": {
    "title": "doc/example/pb/sum.proto",
